...
<body class="bg-white text-slate-800 flex flex-col min-h-screen" x-data="{ searchOpen: false }">
        ...
        <div class="container mx-auto px-4 lg:px-8 flex justify-between items-center gap-4">
            ...
            <a href="/" class="flex items-center gap-3 group select-none shrink-0 animate-fade-in-up bg-transparent" style="background-color: transparent !important;">
                @if($company && $company->logo)
                    {{-- Gambar Logo --}}
                    <img src="{{ Storage::url($company->logo) }}" alt="{{ $company->name }}" class="block h-10 md:h-12 w-auto object-contain bg-transparent" style="background-color: transparent !important; box-shadow: none !important; border: none !important;">
                @else
                    {{-- Teks Alternatif --}}
    ...
    {{-- SCRIPT: Scroll menu samping pakai Mouse Wheel --}}
    <script>
            ...
            <div class="lg:col-span-8 animate-fade-in-up" style="animation-delay: 0.3s;">
                <div class="flex items-center justify-between mb-8">
                    <div class="flex items-center gap-3">
                        ...
                        <h2 class="font-display font-bold text-2xl text-brand-dark">Berita Terbaru</h2>
                    </div>
                </div>
                ...
                @if($latestNews->hasMorePages())
                    <div class="mt-14 pb-8 flex flex-col items-center justify-center" id="load-more-wrapper">
                        <button id="btn-load-more" data-page="2" class="rounded-none group relative px-10 py-4 bg-white text-slate-600 font-display font-bold text-xs uppercase tracking-wider border border-slate-200 shadow-sm hover:border-brand-red hover:text-brand-red hover:bg-slate-50 hover:shadow-md transition-all duration-300 active:scale-95 flex items-center gap-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            // Logika Tombol "Muat Lebih Banyak"
