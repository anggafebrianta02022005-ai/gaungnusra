...
<head>
    ...
    <style>
        ...
        .article-content img { 
            ...
            /* Hapus border-radius agar kotak lancip */
        ...
        @media (min-width: 768px) {
            .article-content img { width: 50% !important; }
        }

        .article-content figcaption, .article-content em, .article-content i { 
            display: block; text-align: center; font-size: 0.9rem; 
            color: #64748B; font-style: italic; margin-bottom: 30px; 
            margin-top: 5px; font-family: 'Plus Jakarta Sans', sans-serif;
            width: 100%; margin-left: auto; margin-right: auto;
        }
        @media (min-width: 768px) {
            .article-content figcaption { width: 50%; }
        }
...
<body class="bg-white text-slate-800 flex flex-col min-h-screen" x-data="{ searchOpen: false }">
    ...
    <main class="container mx-auto px-4 lg:px-8 py-10 flex-grow bg-white">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <article class="lg:col-span-8 animate-fade-in-up" style="animation-delay: 0.3s;">
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        @forelse($news->categories as $category)
                            <a href="{{ route('category.show', $category->slug) }}" class="text-brand-red font-bold text-sm tracking-wide uppercase hover:text-brand-dark hover:underline decoration-2 underline-offset-4 transition-all">
                                {{ $category->name }}
                            </a>
                ...
                <figure class="w-full overflow-hidden shadow-sm mb-8 bg-slate-100">
                ...
                <div class="border-t border-slate-200 mt-10 pt-8 mb-10 animate-fade-in-up" style="animation-delay: 0.2s;">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div class="flex items-center gap-3">
                            <a href="https://api.whatsapp.com/send?text={{ urlencode($news->title . ' ' . request()->url()) }}" target="_blank" class="w-12 h-12 rounded-full bg-[#25D366]/10 text-[#25D366] flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-all duration-300 hover:scale-110 shadow-sm" title="Bagikan ke WhatsApp">
                                <i class="ph-fill ph-whatsapp-logo text-2xl"></i>
                            </a>
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url()) }}" target="_blank" class="w-12 h-12 rounded-full bg-[#1877F2]/10 text-[#1877F2] flex items-center justify-center hover:bg-[#1877F2] hover:text-white transition-all duration-300 hover:scale-110 shadow-sm" title="Bagikan ke Facebook">
                                <i class="ph-fill ph-facebook-logo text-2xl"></i>
                            </a>
                            <button onclick="copyToClipboard('Link')" class="group relative w-12 h-12 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center hover:bg-slate-800 hover:text-white transition-all duration-300 hover:scale-110 shadow-sm" title="Salin Link">
                ...
                <div class="mt-16">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <a href="{{ route('news.show', $rNews->slug) }}" class="group block h-full">
                            <div class="overflow-hidden mb-4 aspect-video bg-slate-100 relative shadow-sm group-hover:shadow-md transition-shadow">
            ...
            <aside class="lg:col-span-4 space-y-10 pl-0 lg:pl-6 border-l border-transparent lg:border-slate-100 animate-fade-in-up" style="animation-delay: 0.4s;">
                <div class="sticky top-24 space-y-8">
                    ...
                    <div>
                        ...
                        @else
                            <div class="bg-brand-misty h-[300px] w-full flex flex-col items-center justify-center text-slate-300 text-center p-6 border border-slate-200 shadow-sm relative overflow-hidden group">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                <div class="md:col-span-1">
                    ...
                    <div class="flex gap-3">
                        <div class="flex space-x-4">
                            ...
                            <a href="#" class="text-slate-400 hover:text-black transition-colors"><i class="ph-fill ph-threads-logo text-lg"></i></a>
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-slate-500 text-sm font-medium">
                        ...
                        <li><a href="{{ route('epaper.latest') }}" target="_blank" class="hover:text-brand-red transition-colors flex items-center gap-2"><span>Koran Cetak (E-Paper)</span></a></li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var searchInput = $('#search-input'), searchResults = $('#search-results'), timeout = null;
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.length > 0) {
                                ...
                                html += '</div>'; searchResults.html(html).addClass('active');
                            } else { searchResults.html('<div class="p-4 text-center text-sm text-slate-400">Tidak ditemukan.</div>').addClass('active'); }
                        }
                    });
                }, 300);
            });
