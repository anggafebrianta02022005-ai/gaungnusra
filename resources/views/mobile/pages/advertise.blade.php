...
<head>
    ...
    <title>Pasang Iklan - {{ $company->name ?? 'Portal Berita' }}</title>
    ...
    <main class="flex-grow bg-white">
        ...
        <div class="px-4 py-4">
            <div class="mb-6 pb-2 border-b border-slate-100">
                <span class="text-[10px] font-bold text-brand-red uppercase tracking-widest">Layanan</span>
                <h1 class="font-display font-extrabold text-2xl text-brand-dark mt-1">Pasang Iklan</h1>
            </div>
            ...
            <div class="space-y-4 mb-8">
                <h3 class="font-display font-bold text-lg text-brand-dark mb-2 flex items-center gap-2">
                    <i class="ph-fill ph-star text-brand-red"></i> Keuntungan
                </h3>

                <div class="bg-slate-50 border border-slate-200 rounded-xl p-4 flex gap-4 items-start">
                    <div class="w-10 h-10 bg-white text-brand-red rounded-lg shadow-sm flex items-center justify-center text-xl shrink-0"><i class="ph-fill ph-browser"></i></div>
                    <div>
                        <h4 class="font-bold text-brand-dark text-sm mb-1">Iklan Header (Atas)</h4>
                        <p class="text-xs text-slate-500 leading-relaxed">Posisi paling strategis. Dilihat pertama kali saat website dibuka.</p>
                    </div>
                </div>

                <div class="bg-slate-50 border border-slate-200 rounded-xl p-4 flex gap-4 items-start">
                    <div class="w-10 h-10 bg-white text-blue-600 rounded-lg shadow-sm flex items-center justify-center text-xl shrink-0"><i class="ph-fill ph-sidebar"></i></div>
                    <div>
                        <h4 class="font-bold text-brand-dark text-sm mb-1">Iklan Sidebar (Samping)</h4>
                        <p class="text-xs text-slate-500 leading-relaxed">Selalu tampil (Sticky) di Desktop, dan tampil di antara konten berita.</p>
                    </div>
                </div>
            </div>

            <div class="bg-brand-dark rounded-xl p-6 text-center relative overflow-hidden shadow-lg">
                ...
                <div class="relative z-10">
                    <h3 class="font-display font-bold text-xl text-white mb-2">Minat Pasang Iklan?</h3>
                    <p class="text-blue-100 text-xs mb-6 px-2">Hubungi kami untuk mendapatkan penawaran harga spesial hari ini.</p>
                    
                    <div class="flex flex-col gap-3">
                        <a href="https://wa.me/{{ $company->phone ?? '' }}?text=Halo%20Admin,%20saya%20mau%20tanya%20iklan." class="flex items-center justify-center gap-2 bg-green-500 text-white w-full py-3 rounded-lg font-bold text-sm shadow-md active:scale-95 transition-transform">
                            <i class="ph-fill ph-whatsapp-logo text-lg"></i> Chat WhatsApp
                        </a>
                        <a href="mailto:{{ $company->email ?? '' }}" class="flex items-center justify-center gap-2 bg-white text-brand-dark w-full py-3 rounded-lg font-bold text-sm shadow-md active:scale-95 transition-transform">
