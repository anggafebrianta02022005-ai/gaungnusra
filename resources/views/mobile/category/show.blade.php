...
<head>
    ...
    {{-- Meta Description --}}
    <meta name="description" content="Berita terbaru kategori {{ $category->name }} - Gaung Nusra Media Online Terpercaya.">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btn-load-more').click(function() {
                ...
                // Gunakan URL window.location agar pagination sesuai halaman kategori (misal: /category/politik?page=2)
