...
<head>
    ...
    {{-- UPDATE 1: META TAGS AGAR SHARE WA/FB MUNCUL GAMBAR --}}
    ...
    {{-- Open Graph (Wajib untuk WhatsApp & Facebook) --}}
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="{{ $company->name ?? 'Gaung Nusra' }} - Media Online">
...
{{-- UPDATE 2: Menambahkan State 'lightboxOpen' di x-data --}}
<body class="bg-white text-slate-800 flex flex-col min-h-screen" 
    ...
    {{-- UPDATE 3: IKLAN HEADER (LOGIKA POPUP + LINK) --}}
    ...
    <main class="flex-grow bg-white">
        ...
        {{-- UPDATE 4: IKLAN SIDEBAR/BAWAH (LOGIKA POPUP + LINK) --}}
